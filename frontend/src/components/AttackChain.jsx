...
import { Card, Severity, Answer, Loading, Failed, Mono, DataRow, SectionTitle, Note, SERIES, severityHex } from './ui'
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="overflow-x-auto px-5 py-5">
          <div className="flex min-w-max items-start gap-1">
            {stages.map((s, i) => {
              ...
              const colour = s.stage ? severityHex(s.stage.severity) : SERIES.inactive
      ...
      <Card
        ...
        hint="Generated by the language model from the stages above."
      >
        <Answer>{data.next_move_prediction}</Answer>
        <div className="mt-3 border-t border-line pt-3">
          <Note>
            This is a projection, not an observation. Nothing here has been detected — it is
            what the model expects next given the stages that have.
          </Note>
        </div>
      </Card>
    </div>
